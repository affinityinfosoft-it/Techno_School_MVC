...
namespace SchoolMVC.Areas.StudentPortal.Controllers.api
{
    public class AttendenceController : ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult GetStudentWiseAttendanceData(AttendenceRequest obj)
        {
            ResultWithData<AttendenceResponse> Result = new ResultWithData<AttendenceResponse>();
            if (User.Identity.IsAuthenticated)
            {
                ...
                try
                {
                    ...
                    var data = service.GetStudentWiseAttendence(obj);
                    if (data != null)
                    {
