...
{
    public class ClassWiseBirthdayController : ApiController
    {
        public Service service = new Service();

        [HttpPost]
        public IHttpActionResult GetClassWiseBirthday(ClassWiseBirthdayRequest obj)
        {
            ResultWithData<ClassWiseBirthdayResponse> Result = new ResultWithData<ClassWiseBirthdayResponse>();
            if (User.Identity.IsAuthenticated)
            {
                ...
                try
                {
                    ...
                    var data = service.GetClassWiseBirthday(obj);
                    if (data != null)
                    {
