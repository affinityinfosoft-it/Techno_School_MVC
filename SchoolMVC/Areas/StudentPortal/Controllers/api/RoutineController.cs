...
namespace SchoolMVC.Areas.StudentPortal.Controllers.api
{
    public class RoutineController : ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult GetRoutine(RoutineRequest obj)
         {
            ResultWithData<RoutineResponse> Result = new ResultWithData<RoutineResponse>();
            if (User.Identity.IsAuthenticated)
            {
                ...
                try
                {
                    ...
                    var data = service.GetRoutine(obj);
                    if (data != null)
                    {
