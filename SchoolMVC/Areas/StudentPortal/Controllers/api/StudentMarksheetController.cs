...
{
    public class StudentMarksheetController : ApiController
    {
        public Service service = new Service();

        [HttpPost]
        public IHttpActionResult GetStudentMarksheet(StudentMarksheetRequest obj)
         {
             ResultWithData<StudentMarksheetResponse> Result = new ResultWithData<StudentMarksheetResponse>();
            if (User.Identity.IsAuthenticated)
            {
                ...
                try
                {
                    ...
                    var data = service.GetStudentMarksheet(obj);
                    if (!String.IsNullOrWhiteSpace(data.STUDENT_ID))
