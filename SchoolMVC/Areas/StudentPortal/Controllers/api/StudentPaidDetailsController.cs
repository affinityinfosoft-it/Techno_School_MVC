...
{
    public class StudentPaidDetailsController : ApiController
    {
        public Service service = new Service();

        [HttpPost]
        public IHttpActionResult GetStudentPaidDetails(StudentPaidDetailsRequest obj)
        {
            ResultWithData<StudentPaidDetailsResponse> Result = new ResultWithData<StudentPaidDetailsResponse>();
            if (User.Identity.IsAuthenticated)
            {
                ...
                try
                {
                    ...
                    var data = service.GetStudentPaidDetails(obj);
                    if (data != null)
                    {
