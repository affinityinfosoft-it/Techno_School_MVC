...
{
    public partial class ClassSecHeadWiseFeesCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //QParameter.ClassId = Convert.ToInt64(ClassId);
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    ...
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/ClassSectionHeadWiseFeesCollectionReport.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("SP_FeesCollectionDetailsReport", ConfigurationManager.ConnectionStrings["School_DbEntity"].ToString()))
            {
                ...
                //if (QParameter.SecId != 0) da.SelectCommand.Parameters.AddWithValue("@SectioId", QParameter.SecId);
                da.SelectCommand.Parameters.AddWithValue("@SectioId", 0);
                ...
                da.Fill(DMSObjSet, "SP_FeesCollectionDetailsReport");
            }

            objReportDoc.Load(Server.MapPath("~/Reports//Academic/RPT/ClassSectionHeadWiseFeesCollectionReport.rpt"));
            CrystalReportViewer.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
            objReportDoc.SetDataSource(DMSObjSet.Tables["SP_FeesCollectionDetailsReport"]);
            //objReportDoc.SetParameterValue("ClassId", QParameter.ClassId);
            //objReportDoc.SetParameterValue("SecId", QParameter.SecId);
