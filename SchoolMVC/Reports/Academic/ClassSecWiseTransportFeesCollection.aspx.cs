...
{
    public partial class ClassSecWiseTransportFeesCollection : System.Web.UI.Page
    {
       DataSet DMSObjSet = null;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/ClassSecWiseTransportFeesCollectionReport.rpt"));
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            objReportDoc.ExportToHttpResponse(formatType, Response, true, "Transport fees collection report ");
            Response.End();
        }
