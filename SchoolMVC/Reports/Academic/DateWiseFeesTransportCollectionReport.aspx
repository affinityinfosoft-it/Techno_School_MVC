<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DateWiseFeesTransportCollectionReport.aspx.cs" Inherits="SchoolMVC.Reports.Academic.DateWiseFeesTransportCollectionReport" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<script src="../../Scripts/jquery-1.12.4.js"></script>
<script src="../../Scripts/jquery-1.12.4.min.js"></script>
<head runat="server">
    <title>Date Wise Fees Transport Collection</title>
</head>
<body>
