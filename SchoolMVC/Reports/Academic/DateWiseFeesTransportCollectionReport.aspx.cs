...
{
    public partial class DateWiseFeesTransportCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/DateWiseFeesTransportCollectionReport.rpt"));
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            objReportDoc.ExportToHttpResponse(formatType, Response, true, "Date Wise Transport fees collection");
            Response.End();
        }
