...
{
    public partial class FeesCollectionDetailsReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    ...
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/FeesCollectionDetailsReports.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("SP_FeesCollectionDetailsReport", ConfigurationManager.ConnectionStrings["School_DbEntity"].ToString()))
            {
                ...
                //if (QParameter.SecId != 0) da.SelectCommand.Parameters.AddWithValue("@ClassId", QParameter.ClassId);
