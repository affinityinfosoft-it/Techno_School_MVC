...
{
    public partial class HostelFeesCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/HostelFeesCollectionReport.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("SP_HosteFeesCollectionReport", ConfigurationManager.ConnectionStrings["School_DbEntity"].ToString()))
            {
                ...
                da.SelectCommand.Parameters.AddWithValue("@hostel_SchoolId", QParameter.SchoolId);
                da.SelectCommand.Parameters.AddWithValue("@hostel_SessionId", QParameter.SessionId);
                da.SelectCommand.CommandTimeout = 600;
                da.Fill(DMSObjSet, "SP_HosteFeesCollectionReport");
            }
            objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/HostelFeesCollectionReport.rpt"));
            CrystalReportViewer.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
            objReportDoc.SetDataSource(DMSObjSet.Tables["SP_HosteFeesCollectionReport"]);
