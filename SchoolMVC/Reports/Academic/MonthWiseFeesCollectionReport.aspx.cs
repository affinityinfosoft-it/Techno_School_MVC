...
{
    public partial class MonthWiseFeesCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    ...
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/MonthWiseFeesCollectionReport.rpt"));
