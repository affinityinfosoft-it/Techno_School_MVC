...
{
    public partial class MonthWiseTransportFeesCollection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/MonthWiseTransportFeesCollectionReport.rpt"));
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            objReportDoc.ExportToHttpResponse(formatType, Response, true, "Month Wise Transport fees collection");
            Response.End();
        }
