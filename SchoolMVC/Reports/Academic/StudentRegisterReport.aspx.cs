...
{
    public partial class StudentRegisterReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    ...
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/StudentRegisterReport.rpt"));
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            objReportDoc.ExportToHttpResponse(formatType, Response, true, "Student register report ");
            Response.End();
        }
