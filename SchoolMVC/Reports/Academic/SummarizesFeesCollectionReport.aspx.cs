...
{
    public partial class SummarizesFeesCollection : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    ...
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/FeesCollectionSummaryReports.rpt"));
        ...
        public void printreport()
        {
            ...
            using (SqlDataAdapter da = new SqlDataAdapter("SP_SummarisedFeesCollection", ConfigurationManager.ConnectionStrings["School_DbEntity"].ToString()))
            {
                ...
                da.Fill(DMSObjSet, "SP_SummarisedFeesCollection");
            }

            objReportDoc.Load(Server.MapPath("~/Reports/Academic/FeesCollectionSummaryReports.rpt"));
            CrystalReportViewer.ToolPanelView = CrystalDecisions.Web.ToolPanelViewType.None;
            objReportDoc.SetDataSource(DMSObjSet.Tables["SP_SummarisedFeesCollection"]);
