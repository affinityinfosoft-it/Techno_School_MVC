...
{
    public partial class TransportFeesCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    objReportDoc.Load(Server.MapPath("~/Reports/Academic/RPT/TransportFeesCollectionReport.rpt"));
        ...
        public void ExportPDFWordExecel(string type)
        {
            ...
            objReportDoc.ExportToHttpResponse(formatType, Response, true, "Transport fees collection Details ");
            Response.End();
        }
