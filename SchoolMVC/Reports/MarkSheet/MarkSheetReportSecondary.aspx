<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MarkSheetReportSecondary.aspx.cs" Inherits="SchoolMVC.Reports.MarkSheet.MarkSheetReportSecondary" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>


<head runat="server">
    <title>MarkSheet Secondary Report</title>
</head>
<body>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form2" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <CR:CrystalReportViewer runat="server" AutoDataBind="true" OnUnload="crystalreportviewer_Unload" ID="CrystalReportViewer" HasToggleGroupTreeButton="false" BestFitPage="true" Width="100%"></CR:CrystalReportViewer>
