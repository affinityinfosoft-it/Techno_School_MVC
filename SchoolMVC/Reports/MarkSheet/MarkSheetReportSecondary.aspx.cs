...
{
    public partial class MarkSheetReportSecondary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack)
            {
                ...
                if (DMSObjSet != null)
                {
                    objReportDoc.Load(Server.MapPath("~/Reports/MarkSheet/SecondaryStudentMarkSheetReport.rpt"));
